...
/**
 * This code snippet remove any identifiers from Customer/Order CSV Export export
...
add_filter( 'wc_customer_order_csv_export_order_headers', 'sv_wc_csv_export_remove_id_headers_for_import', 10, 2 );
...
add_filter( 'wc_customer_order_csv_export_order_row',           'sv_wc_csv_export_remove_ids_for_import', 100 );
add_filter( 'wc_customer_order_csv_export_order_line_item',     'sv_wc_csv_export_remove_ids_for_import', 100 );
add_filter( 'wc_customer_order_csv_export_order_shipping_item', 'sv_wc_csv_export_remove_ids_for_import', 100 );
add_filter( 'wc_customer_order_csv_export_order_fee_item',      'sv_wc_csv_export_remove_ids_for_import', 100 );
add_filter( 'wc_customer_order_csv_export_order_tax_item',      'sv_wc_csv_export_remove_ids_for_import', 100 );
add_filter( 'wc_customer_order_csv_export_order_coupon_item',   'sv_wc_csv_export_remove_ids_for_import', 100 );
add_filter( 'wc_customer_order_csv_export_order_refund_data',   'sv_wc_csv_export_remove_ids_for_import', 100 );
...
add_filter( 'wc_customer_order_csv_export_order_row', 'sv_wc_csv_export_convert_customer_id_to_username', 50, 3 );
