 ...
 */
function sv_wc_xml_export_add_refund_options( $options ) {
...
add_filter( 'wc_customer_order_xml_export_suite_options', 'sv_wc_xml_export_add_refund_options' );
 ...
 */
function sv_wc_xml_export_only_orders_with_refunds( $query_args, $export_type ) {
...
add_filter( 'wc_customer_order_xml_export_suite_query_args', 'sv_wc_xml_export_only_orders_with_refunds', 5, 2 );
