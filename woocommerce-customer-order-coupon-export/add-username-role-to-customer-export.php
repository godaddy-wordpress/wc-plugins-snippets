...
add_filter( 'wc_customer_order_export_csv_customer_headers', 'sv_wc_customer_csv_export_column_headers' );
...
add_filter( 'wc_customer_order_export_csv_customer_row', 'sv_wc_customer_csv_export_customer_row', 10, 2 );
