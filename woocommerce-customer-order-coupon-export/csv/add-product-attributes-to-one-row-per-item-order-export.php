...
add_filter( 'wc_customer_order_export_csv_order_headers', 'sv_wc_csv_export_add_product_attributes_column' );
...
add_filter( 'wc_customer_order_export_csv_order_line_item', 'sv_wc_csv_export_add_product_to_order_line_item', 10, 3 );
...
add_filter( 'wc_customer_order_export_csv_order_row_one_row_per_item', 'sv_wc_csv_export_add_product_attributes', 10, 2 );
