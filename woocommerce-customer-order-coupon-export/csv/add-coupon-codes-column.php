...
/**
 * Adds a dedicated `coupon_codes` column to the CSV output, that outputs only the coupon code(s) used as an
...
add_filter( 'wc_customer_order_export_csv_order_headers', 'sv_wc_csv_export_add_coupon_codes_column', 10, 2 );
...
add_filter( 'wc_customer_order_export_csv_order_row', 'sv_wc_csv_export_add_coupon_codes_data', 10, 3 );
