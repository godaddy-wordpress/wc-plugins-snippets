 ...
 */
function sv_wc_csv_export_update_exported_order_status( $order, $export_method, $order_note, $handler ) {
...
add_action( 'wc_customer_order_export_csv_order_exported', 'sv_wc_csv_export_update_exported_order_status_on_paid', 10, 1 );
